...
<p align="center">
  <a href="https://github.com/GhostWrk/Agent-Smith/releases/tag/v46.12.4"><img src="https://img.shields.io/badge/version-46.12.4-00c853?style=flat-square" alt="Version" /></a>
...
Pre-built **Linux** installers (v46.12.4):

| Format | File | Notes |
|--------|------|-------|
| **AppImage** | [`agent-smith-46.12.4.AppImage`](https://github.com/GhostWrk/Agent-Smith/releases/download/v46.12.4/agent-smith-46.12.4.AppImage) | Portable — `chmod +x` and run |
| **Debian/Ubuntu** | [`agent-smith_46.12.4_amd64.deb`](https://github.com/GhostWrk/Agent-Smith/releases/download/v46.12.4/agent-smith_46.12.4_amd64.deb) | `sudo dpkg -i` then `sudo apt -f install` if needed |
...
<p align="center">
  <sub>Agent Smith v46.12.4 · Built for local models, built for builders.</sub>
</p>