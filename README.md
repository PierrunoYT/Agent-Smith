...
<p align="center">
  <a href="https://github.com/GhostWrk/Agent-Smith/releases/tag/v46.21.0"><img src="https://img.shields.io/badge/version-46.21.0-00c853?style=flat-square" alt="Version" /></a>
...
Pre-built **Linux** installers (v46.21.0):

| Format | File | Notes |
|--------|------|-------|
| **AppImage** | [`agent-smith-46.21.0.AppImage`](https://github.com/GhostWrk/Agent-Smith/releases/download/v46.21.0/agent-smith-46.21.0.AppImage) | Portable — `chmod +x` and run |
| **Debian/Ubuntu** | [`agent-smith_46.21.0_amd64.deb`](https://github.com/GhostWrk/Agent-Smith/releases/download/v46.21.0/agent-smith_46.21.0_amd64.deb) | `sudo dpkg -i` then `sudo apt -f install` if needed |
...
<p align="center">
  <sub>Agent Smith v46.21.0 · Built for local models, built for builders.</sub>
</p>