...
<p align="center">
  <a href="https://github.com/GhostWrk/Agent-Smith/releases/tag/v46.12.1"><img src="https://img.shields.io/badge/version-46.12.1-00c853?style=flat-square" alt="Version" /></a>
...
Pre-built **Linux** installers (v46.12.1):

| Format | File | Notes |
|--------|------|-------|
| **AppImage** | [`agent-smith-46.12.1.AppImage`](https://github.com/GhostWrk/Agent-Smith/releases/download/v46.12.1/agent-smith-46.12.1.AppImage) | Portable — `chmod +x` and run |
| **Debian/Ubuntu** | [`agent-smith_46.12.1_amd64.deb`](https://github.com/GhostWrk/Agent-Smith/releases/download/v46.12.1/agent-smith_46.12.1_amd64.deb) | `sudo dpkg -i` then `sudo apt -f install` if needed |
...
<p align="center">
  <sub>Agent Smith v46.12.1 · Built for local models, built for builders.</sub>
</p>